  ...
  <div class="submit-form mt-3 mx-auto">
    ...
    <div v-if="!submitted">
      <v-form ref="form" lazy-validation>
        <!-- v-model.trim (trim the string) -->
        <!-- v-model.number (allow only type of number)-->
        <!-- v-model.trim.lazy (better perfomance, does not have to bind, update value when lost focus)-->
        <!-- v-bind:src = "url" -->
        <v-text-field
